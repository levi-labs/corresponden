                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Hobby</div>
                                    <div class="col-lg-9 col-md-8">{{ $data->hobby ?? '-' }}</div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Year Enrolled</div>
                                    <div class="col-lg-9 col-md-8">{{ $data->year_enrolled ?? '-' }}</div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Year Graduated</div>
                                    <div class="col-lg-9 col-md-8">{{ $data->year_graduated ?? '-' }}</div>
                                </div>
